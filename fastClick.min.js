...
var fastClick=function(a,b){document.createTouch&&(fastClick.init(a,b),fastClick.windowBinder&&fastClick.windowBinder(),fastClick.windowBinder=void 0)};fastClick.coords=[];fastClick.clickWait=2E3;fastClick.windowBinder=function(){window.addEventListener("click",fastClick.windowHandler,!0)};
fastClick.windowHandler=function(a){var b=a.target,c=b["data-fc-store"];if(!c||!c.clickable){for(var c=a.changedTouches?a.changedTouches[0]:a,e=fastClick.coords,d=0,g=e.length;d<g;d+=2){var f=e[d+1],i=Math.abs(c.clientX-e[d]),f=Math.abs(c.clientY-f);25>i&&25>f&&(event.returnValue=!1,b["data-fc-store"]=void 0,a.stopPropagation(),a.preventDefault(),a.stopImmediatePropagation&&a.stopImmediatePropagation())}return event.returnValue}};
fastClick.init=function(a,b){for(var c=a?document.querySelectorAll(a):[document],e=window.Node?window.Node.DOCUMENT_POSITION_CONTAINED_BY:void 0,d=0,g=c.length;d<g;++d){var f=c[d];b?f.addEventListener("touchstart",function(a){for(var c=f.querySelectorAll(b),d=0,g=c.length;d<g;++d){var h=c[d].compareDocumentPosition(a.target);if(0===h||h&e)return}fastClick.onTouchStart(a)},!1):f.addEventListener("touchstart",fastClick.onTouchStart,!1)}};
